...
import (
	...
	types "github.com/metis-seq/themis/types/error"
...
func TestPermCheck(t *testing.T) {
	...
	tc := []struct {
		...
		{
			filePath:  "/tmp/themis_test/test.json",
			perm:      0777,
			validPerm: 0600,
			expErr:    types.InvalidPermissionsError{File: "/tmp/themis_test/test.json", Perm: 0600},
