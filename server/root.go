...
import (
	...
	tx "github.com/metis-seq/themis/client/tx"
	"github.com/metis-seq/themis/helper"

	// unnamed import of statik for swagger UI support
	"github.com/metis-seq/themis/server/gRPC"
	_ "github.com/metis-seq/themis/server/statik"
)
...
func StartRestServer(mainCtx ctx.Context, cdc *codec.Codec, registerRoutesFn func(ctx client.CLIContext, mux *mux.Router), restCh chan struct{}) error {
	...
	g.Go(func() error {
		...
		<-gCtx.Done()
		logger.Info("Shutting down themis rest server...")
...
// this is borrowed from metis-seq rpcserver
...
func RegisterRoutes(ctx client.CLIContext, mux *mux.Router) {
	...
	// metis.RegisterRoutes(rs.CliCtx, rs.Mux, rs.Cdc)
