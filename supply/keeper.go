...
import (
	...
	bank "github.com/metis-seq/themis/bank"
...
func (k Keeper) GetModuleAddress(moduleName string) (addr hmTypes.ThemisAddress) {
...
func (k Keeper) GetModuleAddressAndPermissions(moduleName string) (addr hmTypes.ThemisAddress, permissions []string) {
	permAddr, ok := k.permAddrs[moduleName]
	if !ok {
...
func (k Keeper) SendCoinsFromModuleToAccount(
	ctx sdk.Context,
	senderModule string,
	recipientAddr hmTypes.ThemisAddress,
	amt sdk.Coins,
) sdk.Error {
...
func (k Keeper) SendCoinsFromAccountToModule(
	ctx sdk.Context,
	senderAddr hmTypes.ThemisAddress,
	recipientModule string,
	amt sdk.Coins,
) sdk.Error {
	// create the account if it doesn't yet exist
