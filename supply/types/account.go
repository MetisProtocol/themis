...
import (
	...
	authExported "github.com/metis-seq/themis/auth/exported"
	authTypes "github.com/metis-seq/themis/auth/types"
	"github.com/metis-seq/themis/supply/exported"
...
func NewModuleAddress(name string) types.ThemisAddress {
	return types.BytesToThemisAddress(crypto.AddressHash([]byte(name)).Bytes())
}
