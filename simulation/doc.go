/*
Package simulation implements a full fledged Themis application used for executing
simulation test suites.

The Themis type defines an application used for running extensive simulation
testing suites. It contains all core modules, including governance and staking.
