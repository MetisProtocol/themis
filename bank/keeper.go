...
func (keeper Keeper) SetCoins(
	ctx sdk.Context, addr hmTypes.ThemisAddress, amt sdk.Coins,
) sdk.Error {
...
func (keeper Keeper) SendCoins(
	ctx sdk.Context, fromAddr hmTypes.ThemisAddress, toAddr hmTypes.ThemisAddress, amt sdk.Coins,
) sdk.Error {
...
func (keeper Keeper) GetCoins(ctx sdk.Context, addr hmTypes.ThemisAddress) sdk.Coins {
	acc := keeper.ak.GetAccount(ctx, addr)
	if acc == nil {
		return sdk.NewCoins()
	}
...
func (keeper Keeper) HasCoins(ctx sdk.Context, addr hmTypes.ThemisAddress, amt sdk.Coins) bool {
