...
import (
	...
	metisCli "github.com/metis-seq/themis/metis/client/cli"
	metisRest "github.com/metis-seq/themis/metis/client/rest"
...
var (
	...
	_ hmModule.ThemisModuleBasic = AppModule{}
...
func (AppModuleBasic) RegisterRESTRoutes(ctx context.CLIContext, rtr *mux.Router) {
	metisRest.RegisterRoutes(ctx, rtr)
}

// GetTxCmd returns the root tx command for the auth module.
func (AppModuleBasic) GetTxCmd(cdc *codec.Codec) *cobra.Command {
	return metisCli.GetTxCmd(cdc)
}

// GetQueryCmd returns the root query command for the auth module.
func (AppModuleBasic) GetQueryCmd(cdc *codec.Codec) *cobra.Command {
	return metisCli.GetQueryCmd(cdc)
}
...
func NewAppModule(keeper Keeper, stakingKeeper staking.Keeper, contractCaller helper.IContractCaller) AppModule {
	return AppModule{
