...
// WithGasAdjustment returns a copy of the context with an gas adjustment.
func (bldr TxBuilder) WithGasAdjustment(gasAdjustment float64) TxBuilder {
	bldr.gasAdjustment = gasAdjustment
