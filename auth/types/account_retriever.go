...
func (ar AccountRetriever) GetAccount(addr types.ThemisAddress) (Account, error) {
...
// or decoding fails.
func (ar AccountRetriever) GetAccountWithHeight(addr types.ThemisAddress) (Account, int64, error) {
...
func (ar AccountRetriever) EnsureExists(addr types.ThemisAddress) error {
...
func (ar AccountRetriever) GetAccountNumberSequence(addr types.ThemisAddress) (uint64, uint64, error) {
