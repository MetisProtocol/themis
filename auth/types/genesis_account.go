...
import (
	...
	supplyExported "github.com/metis-seq/themis/supply/exported"
...
type GenesisAccount struct {
	Address       hmTypes.ThemisAddress `json:"address" yaml:"address"`
...
func (gaccs GenesisAccounts) Contains(acc hmTypes.ThemisAddress) bool {
