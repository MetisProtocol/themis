...
type BaseAccount struct {
	Address       types.ThemisAddress `json:"address" yaml:"address"`
...
func NewBaseAccountWithAddress(addr types.ThemisAddress) BaseAccount {
	return BaseAccount{
		Address: addr,
	}
}
...
func (acc BaseAccount) GetAddress() types.ThemisAddress {
	return acc.Address
}

// SetAddress - Implements sdk.Account.
func (acc *BaseAccount) SetAddress(addr types.ThemisAddress) error {
