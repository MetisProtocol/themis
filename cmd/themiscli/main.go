...
import (
	...
	authCli "github.com/metis-seq/themis/auth/client/cli"
	hmTxCli "github.com/metis-seq/themis/client/tx"
	"github.com/metis-seq/themis/helper"
)

var logger = helper.Logger.With("module", "cmd/themiscli")

// rootCmd is the entry point for this binary
var (
	rootCmd = &cobra.Command{
		Use:   "themiscli",
		Short: "Themis light-client",
...
func main() {
	...
	executor := cli.PrepareMainCmd(rootCmd, "HD", os.ExpandEnv("/var/lib/themis"))
...
func exportCmd(ctx *server.Context, cdc *codec.Codec) *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(_ *cobra.Command, _ []string) error {
			...
			happ := app.NewThemisApp(logger, db)
