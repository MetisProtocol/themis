module github.com/metis-seq/themis
...
// DO NOT REMOVE. Need to replace this to avoid invalid version specificed in old tendermint pacakage
replace github.com/ethereum/go-ethereum => github.com/ethereum/go-ethereum v1.14.11

replace github.com/multiformats/go-multiaddr => github.com/multiformats/go-multiaddr v0.13.0
