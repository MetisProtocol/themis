...
func (keeper Keeper) AddVote(ctx sdk.Context, proposalID uint64, voter hmTypes.ThemisAddress, option types.VoteOption, validator hmTypes.ValidatorID) sdk.Error {
