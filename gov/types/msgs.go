...
type MsgSubmitProposal struct {
	...
	Proposer       hmTypes.ThemisAddress `json:"proposer" yaml:"proposer"`               //  Address of the proposer
	Validator      hmTypes.ValidatorID   `json:"validator" yaml:"validator"`             //  Validator id
}

// NewMsgSubmitProposal creates new submit proposal
func NewMsgSubmitProposal(content Content, initialDeposit sdk.Coins, proposer hmTypes.ThemisAddress, validator hmTypes.ValidatorID) MsgSubmitProposal {
...
type MsgDeposit struct {
	...
	Depositor  hmTypes.ThemisAddress `json:"depositor" yaml:"depositor"`     // Address of the depositor
	Amount     sdk.Coins             `json:"amount" yaml:"amount"`           // Coins to add to the proposal's deposit
	Validator  hmTypes.ValidatorID   `json:"validator" yaml:"validator"`     //  Validator id
}

func NewMsgDeposit(depositor hmTypes.ThemisAddress, proposalID uint64, amount sdk.Coins, validator hmTypes.ValidatorID) MsgDeposit {
...
func (msg MsgDeposit) GetSigners() []sdk.AccAddress {
	return []sdk.AccAddress{hmTypes.ThemisAddressToAccAddress(msg.Depositor)}
}

// MsgVote
type MsgVote struct {
	ProposalID uint64                `json:"proposal_id" yaml:"proposal_id"` // ID of the proposal
	Voter      hmTypes.ThemisAddress `json:"voter" yaml:"voter"`             //  address of the voter
...
func NewMsgVote(voter hmTypes.ThemisAddress, proposalID uint64, option VoteOption, validator hmTypes.ValidatorID) MsgVote {
...
func (msg MsgVote) GetSigners() []sdk.AccAddress {
	return []sdk.AccAddress{hmTypes.ThemisAddressToAccAddress(msg.Voter)}
}
