...
func (keeper Keeper) AddDeposit(ctx sdk.Context, proposalID uint64, depositorAddr hmTypes.ThemisAddress, depositAmount sdk.Coins, validator hmTypes.ValidatorID) (sdk.Error, bool) {
